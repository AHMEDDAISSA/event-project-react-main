...
const HotelData = [
  {
    ...
    services: [
      ...
      {id: '2', icon: 'coffee-maker',     name: 'Free Coffee'},
      {id: '3', icon: 'bathtub',          name: 'Free Bath'},
      {id: '4', icon: 'directions-car',   name: 'Free Car'},
      {id: '5', icon: 'pets',             name: 'Free Paw'},
      {id: '6', icon: 'sports-soccer',    name: 'Free Futbol'},
    ],
  },
  {
    id: '2',
