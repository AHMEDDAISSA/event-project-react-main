  ...
  return (
    <View style={{flex: 1}}>
      ...
      <Header
        ...
        renderRight={() => {
          return <Icon name="photo-library" size={20} color={BaseColor.whiteColor} />;
        }}
        onPressLeft={() => {
          navigation.goBack();
        }}
        ...
        <ScrollView
          ...
          <View style={{paddingHorizontal: 20}}>
            ...
            <View
              ...
              {[
                {key: '1', name: 'wifi', icon: 'wifi'},
                {key: '2', name: 'coffee', icon: 'coffee'},
                {key: '3', name: 'bath', icon: 'bathtub'},
                {key: '4', name: 'car', icon: 'directions-car'},
              ].map((item, index) => (
            ...
            <View style={{paddingVertical: 10}}>
              ...
              <View style={styles.itemReason}>
                <Icon name="fastfood" size={20} color={colors.accent} />
                <View style={{marginLeft: 10}}>
                  <Text subhead semibold>
                    Great Food
                  </Text>
              ...
              <View style={styles.itemReason}>
                <Icon name="beach-access" size={20} color={colors.accent} />
                <View style={{marginLeft: 10}}>
                  <Text subhead semibold>
                    Private Beach
                  </Text>
