...
import {Image, Text, Icon, StarRating, Tag} from '../index';
      ...
      <View style={style}>
        ...
        <View style={{paddingHorizontal: 20}}>
          ...
          <View style={styles.blockContentAddress}>
            <Icon name="location-on" color={colors.primaryLight} size={10} />
            <Text
              caption1
              grayColor
              style={{
        ...
        <View style={styles.contentService}>
          ...
          <TouchableOpacity
            ...
            <Icon name="chevron-right" size={16} color={BaseColor.dividerColor} />
          </TouchableOpacity>
        </View>
      </View>
    );
    ...
    return (
      <View style={[styles.girdContent, style]}>
        ...
        <View style={styles.girdContentLocation}>
          <Icon name="location-on" color={colors.primary} size={16} />
          <Text
            caption2
            grayColor
            style={{
